...
2022-08-31 04:46:40 --- EMERGENCY: View_Exception [ 0 ]: The requested view common/messages/v_error could not be found ~ SYSPATH/classes/Kohana/View.php [ 257 ] in /home/qualime/testy.quali.me/public_html/system/classes/Kohana/View.php:137
2022-08-31 04:46:40 --- DEBUG: #0 /home/qualime/testy.quali.me/public_html/system/classes/Kohana/View.php(137): Kohana_View->set_filename('common/messages...')
...
2022-08-31 05:26:44 --- EMERGENCY: Database_Exception [ 1451 ]: Cannot delete or update a parent row: a foreign key constraint fails (`qualime_tst`.`tests_results`, CONSTRAINT `tests_results_ibfk_1` FOREIGN KEY (`test_id`) REFERENCES `tests` (`id`)) [ DELETE FROM `tests` WHERE `id` = '328' ] ~ MODPATH/kohana-3.3-mysqli/classes/Database/MySQLi.php [ 174 ] in /home/qualime/testy.quali.me/public_html/modules/database/classes/Kohana/Database/Query.php:251
2022-08-31 05:26:44 --- DEBUG: #0 /home/qualime/testy.quali.me/public_html/modules/database/classes/Kohana/Database/Query.php(251): Database_MySQLi->query(4, 'DELETE FROM `te...', false, Array)
